...
// (a Node, a Pod, another CloudNativePG CRD instance...) can be rendered as a link
...
// (seen on another extension of this organization), with nothing in the console to explain why. Two properties of
...
export const referenceLogPrefix = "[cnpg-extension]";
 ...
 * behaves differently from a local one. `ns=*` means the store was
