...
// Whether a referenced object (a Node, a Pod, another CloudNativePG CRD
...
// (DESIGN.md section 3: core's `LinkToNode`/`LinkToPod` and
...
// in the first place is `reference-loader.ts`.
