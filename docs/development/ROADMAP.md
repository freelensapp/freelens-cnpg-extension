...
| ObjectStore (Barman Cloud plugin) list + detail with referring clusters and the plugin's recovery windows | [SPEC-0009](../specs/SPEC-0009-m3-object-stores.md) | Approved |
